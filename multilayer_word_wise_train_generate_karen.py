...
MODEL_CHECKPOINT_PATH = 'model/multilayer_word-wise-karen_{epoch:02d}.h5'
MODEL_FILE_PATH = 'model/multilayer_word-wise-karen.h5'
GENERATED_TEXT_PATH = 'generated_text/multilayer_word-wise-karen_diversity_{}.txt'
...
def create_model(vocab_size, embedding_dim=50, hidden=128, dropout_rate=0.5):
